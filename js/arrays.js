...
export const arrays = () => {
    ...
    const firstSectionFirstBtn = document.getElementById("task6.1");
    ...
    const firstSectionSecondBtn = document.getElementById("task6.2");
    ...
    const firstSectionThirdBtn = document.getElementById("task6.3");
    ...
    //Функция изменения времени на переданное количество часов. 
    //Учтите, что в последних 3-х функциях, при изменении одной части времени, может измениться и другая. Например, если ко времени «20:30:45» добавить 30 секунд, то должно получиться «20:31:15», а не «20:30:75».
    const firstSectionFourthBtn = document.getElementById("task6.4");
