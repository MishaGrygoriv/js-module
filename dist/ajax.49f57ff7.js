...
},{}],"js/ajax/index.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.moviesUrls = exports.BASE_MOVIES_URL = void 0;
const BASE_MOVIES_URL = "http://www.omdbapi.com";
exports.BASE_MOVIES_URL = BASE_MOVIES_URL;
const api_key = "d2e8935e";
const moviesUrls = {
  search: `${BASE_MOVIES_URL}/?apikey=${api_key}`
};
exports.moviesUrls = moviesUrls;
},{}],"js/ajax/ajax.js":[function(require,module,exports) {
"use strict";
...
const getSearchMovies = (() => {
  var _ref = _asyncToGenerator(function* (query) {
    try {
      const res = yield fetch(`${_ajax.moviesUrls.search}&s=${query}`);
  ...
  [].forEach.call(document.querySelectorAll('.details-btn'), function (el) {
    el.addEventListener('click', (() => {
      var _ref2 = _asyncToGenerator(function* (e) {
        ...
        const data = yield getMovieById(movieId);
...
document.addEventListener("DOMContentLoaded", _asyncToGenerator(function* () {
  const randomMovie = yield getSearchMovies();
  userInput.addEventListener('input', (() => {
    var _ref4 = _asyncToGenerator(function* (e) {
      const res = yield getSearchMovies(e.target.value);
...
},{"uikit":"node_modules/uikit/dist/js/uikit.js","../ajax":"js/ajax/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/ajax/ajax.js"], null)
//# sourceMappingURL=/ajax.49f57ff7.js.map